...
ActiveRecord::Schema.define(version: 2019_01_31_170331) do
  ...
  create_table "link_specialties", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_link_specialties_on_doctor_id"
    t.index ["specialty_id"], name: "index_link_specialties_on_specialty_id"
  end
